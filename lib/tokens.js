...
class Scanner {
    ...
    next_no_advance() {
        ...
        if (curr == '"' || curr == "'") {
            ...
            if (this.at_EOF()) {
                (0, error_1.error)(this.lines, {
                    ...
                    col: this.col(),
                    length: 1,
                }, `Expected closing quote ${quote} to string`, this.add_color);
            }
        ...
        console.log((0, error_1.error)(this.lines, this.get_position(1), `Unexpected character ${curr}`, this.add_color));
        this.advance();
